...
VALUES  ('3333', 'Сергей', 'Васильев', '+7(999)0084125', 'igorkarpy@gmail.com', 'Заявка'),
        ('4444', 'Вова', 'Седой', '+7(978)0254125', 'koshka@gmail.com', 'Заявка'),
        ('3333', 'Сергей', 'Васильев', '+7(999)0084125', 'igorkarpy@gmail.com', 'Заявка');

INSERT INTO order_work (order_id, work_id, status)
VALUES  (1, 11, 'Не выполнена'),
        (1, 14, 'Не выполнена'),
        (1, 17, 'Не выполнена'),
        (1, 18, 'Не выполнена'),
        (1, 25, 'Не выполнена'),
