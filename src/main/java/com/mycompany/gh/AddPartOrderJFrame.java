...
public class AddPartOrderJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        newPartLabel.setText("Новый заказ");
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (evt.getSource()==saveButton) {
            ...
            PartOrderDB partadd = new PartOrderDB();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPartOrderJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
